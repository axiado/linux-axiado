...
static const struct axiado_board_type axiado_board_types[] = {
	{ 0x20204D54, "mTahoe" }, /* AXIADO_MFD_BOARD_TYPE_MT, old type */
	{ 0x20205342, "Snowbird" }, /* AXIADO_MFD_BOARD_TYPE_SB, old type */
	{ 0x204D5431, "mTahoe1" }, /* AXIADO_MFD_BOARD_TYPE_MT1 */
	{ 0x204D5432, "mTahoe2" }, /* AXIADO_MFD_BOARD_TYPE_MT2 */
	{ 0x20534231, "Snowbird1" }, /* AXIADO_MFD_BOARD_TYPE_SB1 */
	{ 0x20534232, "Snowbird2" }, /* AXIADO_MFD_BOARD_TYPE_SB2 */
	{ 0x4D545332, "mTahoeS2" }, /* AXIADO_MFD_BOARD_TYPE_MTS2 */
	{ 0x20485632, "HV2" }, /* AXIADO_MFD_BOARD_TYPE_HV2 */
	{ 0x20485633, "HV3" }, /* AXIADO_MFD_BOARD_TYPE_HV3 */
};
