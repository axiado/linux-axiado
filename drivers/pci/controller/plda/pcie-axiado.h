...
#define REG_PCIE_EQ_PRESET16 (0x0100 + 0x0050)
#define REG_PCIE_EQ_TUNING_31_00_ADRS_OFFSET (0x0300 + 0x005C)
...
//#define REG_PCIE_X2_IP_CTRL_ADRS_OFFSET 0x058
...
/* PERST# pullup control via IOCTL pad register */
#define PCIE_PERST_PULLUP_BIT BIT(2)
...
#define PCIE_STORAGE_CLASS_CODE \
	0x01800000 /* PCIe Class Code for Storage Mode */
#define PCIE_TRUSTEDS_CLASS_CODE \
	0x0B800000 /* PCIe Class Code for Trusted Services Mode */
#define PCIE_PERST_PULLUP_SET (0x1 << 22)
#define PCIE_PHY_GEN1 (0x1 << 12)
#define PCIE_PHY_GEN2 (0x3 << 12)
#define PCIE_PHY_GEN3 (0x7 << 12)
#define PCIE_PHY_GEN4 0x1F4 /* IP_CTRL speed field [11:0] value */
...
#define PCIE_PHY_SPEED_MASK 0xFFFFF000 /* PHY speed mask */
...
#define PCIE_PHY_CONF_CTRL_LTSSM_ALL 0xFFFFFFF8
#define PCIE_PHY_FREQ_MASK 0xFF800001

/* IP_CTRL register field helpers */
#define REG_PCIE_IP_CTRL_RP_NEP_SET(dst, val) \
	(((u32)(dst) & ~0x1) | ((u32)(val)&0x1))
#define REG_PCIE_IP_CTRL_FREQ_SET(dst, val) \
	(((u32)(dst) & ~0x7FFFFE) | (((u32)(val) << 1) & 0x7FFFFE))
#define REG_PCIE_IP_CTRL_TL_CLK_GATE_EN_SET(dst, val) \
	(((u32)(dst) & ~0x800000) | (((u32)(val) << 23) & 0x800000))

/* RESET_CTRL register field helpers */
#define REG_PCIE_RESET_CTRL_PCIE_RSTN_SET(dst, val) \
	(((u32)(dst) & ~0x1) | ((u32)(val)&0x1))
#define REG_PCIE_RESET_CTRL_HOLD_PIPE_RST_SET(dst, val) \
	(((u32)(dst) & ~0x2) | (((u32)(val) << 1) & 0x2))
#define REG_PCIE_RESET_CTRL_PCIE_RP_PERST_SET(dst, val) \
	(((u32)(dst) & ~0x4) | (((u32)(val) << 2) & 0x4))

/* K_SET GEN_SETTINGS register field helpers */
#define PCIE_K_SET_PCIE_PORT_TYPE_SET(dst, val) \
	(((u32)(dst) & ~0x1) | ((u32)(val)&0x1))
#define PCIE_K_SET_LINK_SPEED_SET(dst, val) \
	(((u32)(dst) & ~0xF000) | (((u32)(val) << 12) & 0xF000))
#define PCIE_K_SET_LANE_REVERSAL_EN_SET(dst, val) \
	(((u32)(dst) & ~0x80) | (((u32)(val) << 7) & 0x80))
#define PCIE_K_SET_LINK_WIDTH_X2_SET(dst, val) \
	(((u32)(dst) & ~0x100) | (((u32)(val) << 8) & 0x100))

/* PHYMAC_CFG register field helpers */
#define PCIE_PHYMAC_CFG_PER_EQ_PHASE_2_3_SET(dst, val) \
	(((u32)(dst) & ~0x1) | ((u32)(val)&0x1))
#define PCIE_PHYMAC_CFG_RXELECIDLE_SET(dst, val) \
	(((u32)(dst) & ~0x2) | (((u32)(val) << 1) & 0x2))
#define PCIE_PHYMAC_CFG_RX_VALID_FILTER_EN_SET(dst, val) \
	(((u32)(dst) & ~0x4) | (((u32)(val) << 2) & 0x4))
#define PCIE_PHYMAC_CFG_ENHANCE_EQ_SET(dst, val) \
	(((u32)(dst) & ~0x18) | (((u32)(val) << 3) & 0x18))

/* EQ tuning 64-bit field helpers */
#define PCIE_EQ_TUNING_63_0_PRESET_TUNING_SETTINGS_SET(dst, val) \
	((u64)(((u64)(dst) & ~0x3ULL) | ((u64)(val)&0x3ULL)))
#define PCIE_EQ_TUNING_63_0_CONT_FINE_TUNE_EVEN_IF_NO_COEFF_SET(dst, val) \
	((u64)(((u64)(dst) & ~0x4ULL) | (((u64)(val) << 2) & 0x4ULL)))
#define PCIE_EQ_TUNING_63_0_GEN3_PRESET_SET(dst, val) \
	((u64)(((u64)(dst) & ~0x7FF0000ULL) |         \
	       (((u64)(val) << 16) & 0x7FF0000ULL)))
#define PCIE_EQ_TUNING_63_0_GEN3_MAX_TUNING_ITER_SET(dst, val) \
	((u64)(((u64)(dst) & ~0x3F0000000ULL) |                \
	       (((u64)(val) << 28) & 0x3F0000000ULL)))
#define PCIE_EQ_TUNING_63_0_GEN4_PRESET_SET(dst, val) \
	((u64)(((u64)(dst) & ~0x7FF000000000ULL) |    \
	       (((u64)(val) << 36) & 0x7FF000000000ULL)))
#define PCIE_EQ_TUNING_63_0_GEN4_MAX_TUNING_ITER_SET(dst, val) \
	((u64)(((u64)(dst) & ~0x3F000000000000ULL) |           \
	       (((u64)(val) << 48) & 0x3F000000000000ULL)))

/* EQ preset/tuning constants */
...
#define PCIE_EQ_PRESET16_MASK 0xFFFF
#define PCIE_EQ_PRESET16_VAL 0x6666
#define PCIE_EQ_TUNNING_31_0_MASK 0x7
#define PCIE_EQ_TUNNING_31_0_VAL 0x6
#define PCIE_EQ_TUNNING_63_32_MASK 0x003F7FF0
#define PCIE_EQ_TUNNING_63_32_VAL 0x00320400
#define PCIE_GEN3_RX_TX_PRESET_GET(rx, tx) \
	((u32)((((rx) << 4) | (tx)) | ((((rx) << 4) | (tx)) << 16)))
#define PCIE_GEN4_RX_TX_PRESET_GET(rx, tx)                          \
	((u32)((((rx) << 4) | (tx)) | ((((rx) << 4) | (tx)) << 8) | \
	       ((((rx) << 4) | (tx)) << 16) | ((((rx) << 4) | (tx)) << 24)))
...
/* IMASK_LOCAL, ISTATUS_LOCAL, IMSI_ADDR, ISTATUS_MSI defined in pcie-plda.h */
...
int axiado_pcie_port_check_link(struct axiado_pcie_port *port,
